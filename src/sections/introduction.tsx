...
export const introduction = section("Introduction", [], [
    ...
    <p>
        Palm is a statically-typed general-prurpose multi-paradigm programming language for the JVM with the goal of being 
        as simplistic yet as expressive as possible.
    </p>
], [
    section("Notation", [], [
        <p>
