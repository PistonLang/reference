...
const properties = GrammarSection(
	...
	[],
	<>
		<p>Properties are a pair of a getter and, potentially, setter function bound to an identifier.</p>
	</>,
	[
		GrammarSection(
			'Getters',
			[defs.GetterDef],
			<>
				<p>Getters are functions which are called when a property is being accessed.</p>
			</>
		),
		GrammarSection(
			'Setters',
