...
const functions = GrammarSection(
	...
	<>
		...
		<p>
			...
			language, functions are differentiated by their signature which is an ordered pair of their names and the types of
			their parameters. As a result, two functions would not be distinct if they only differ by their return type and/or
