...
export const functions = section("Functions", [
    ...
    <p>
        Function parameters in Palm are immutable references to the values passed into the function which may be
        used inside its expression.
    </p>,
    <p>
