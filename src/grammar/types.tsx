...
const _defs: Record<keyof typeof types, GrammarPoints> = {
    ...
    TypeParams: [tokens.lBracket, many(funcs.Identifier, option(tokens.commaOrNL)), option(funcs.Identifier), tokens.rBracket],
    ...
    ClassDef: [tokens.classKw, funcs.Identifier, option(types.TypeParams), option(funcs.FunctionParams), option(types.SuperTypes), option(types.WhereClause), option(scopes.StatementBlock)],
    TraitDef: [tokens.traitKw, funcs.Identifier, option(types.TypeParams), option(types.SuperTypes), option(types.WhereClause), option(scopes.StatementBlock)],
}
